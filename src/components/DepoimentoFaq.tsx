    ...
    <section className="bg-[#0F1B48] w-full flex flex-col items-center pb-32 pt-20">
      ...
      <div className="relative w-[90%] md:w-[70%]">
        ...
        <div className="bg-gradient-to-r from-[#4da0ff] to-[#89b6ff] rounded-xl p-10 text-white relative overflow-hidden">
          ...
          <button
            onClick={goPrev}
            className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-white/20 rounded-full hover:bg-white/30 transition"
          >
            <ChevronLeft />
          </button>
          ...
          <button
            onClick={goNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-white/20 rounded-full hover:bg-white/30 transition"
          >
            <ChevronRight />
          </button>
